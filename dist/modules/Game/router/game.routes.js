...
router.post("/create", BodyValidator_1.validateBodyGameCreate, controller.createGame);
router.post("/img/:id", uploaderImg.single("image"), controller.uploadGameImg);
router.put("/edit/:id", BodyValidator_1.validateBodyGameEdit, controller.editGame);
